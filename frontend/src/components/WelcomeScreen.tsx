...
const QUICK_ACTIONS = [
  { icon: '🎯', title: 'Full Domain Scan', desc: 'Nmap + SSL + DNS + Headers - real results, not suggestions', q: 'Scan scanme.nmap.org - run nmap, ssl check, dns recon, and http headers', scan: false },
  ...
  return (
    <div className="text-center py-10 animate-slide-in">
      ...
      <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight mb-1">
        Welcome to <span className="bg-gradient-to-r from-cs-cyan to-cs-purple bg-clip-text text-transparent">SecOps-Agent</span>
      </h1>
      <p className="text-[0.55rem] text-cs-text3 font-mono mb-1">developed by <span className="text-cs-cyan/70">Baskaran Elilan</span></p>
