  ...
  return (
    <header className="col-span-full bg-cs-bg2 border-b border-cs-border flex items-center justify-between px-4 z-10">
      <div className="flex items-center gap-3 cursor-pointer select-none" onClick={onNewChat}>
        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-cs-cyan to-cs-purple flex items-center justify-center text-sm font-extrabold text-cs-bg font-mono">SA</div>
        <div className="leading-tight">
          <div className="font-bold text-sm tracking-tight">SecOps-<span className="text-cs-cyan">Agent</span> <span className="text-[0.6rem] text-cs-text3 bg-cs-bg3 px-1.5 py-0.5 rounded font-mono ml-1">33 TOOLS</span></div>
          <div className="text-[0.5rem] text-cs-text3 font-mono">developed by <span className="text-cs-cyan/70">Baskaran Elilan</span></div>
        </div>
      </div>
