"""
SecOps-Agent v3.0 - Tools Router
...
TOOL_QUERIES = {
    ...
    "SSL/TLS Checker": [
        ...
        "Scan for weak cipher suites on scanme.nmap.org",
    ...
    "DNS Recon": [
        "Enumerate all subdomains for scanme.nmap.org",
    ...
    "Nuclei Scanner": [
        ...
        "Nuclei scan on scanme.nmap.org with all templates",
    ],
    "SQLMap Scanner": [
    ...
    "Subfinder": [
        "Find all subdomains for scanme.nmap.org",
    ...
    "WHOIS Lookup": [
        ...
        "Check domain registration details for scanme.nmap.org",
    ...
    "Ping / Traceroute": [
        ...
        "Trace route to scanme.nmap.org",
    ...
    "Zeek Analyzer": [
        ...
        "Network traffic analysis on scanme.nmap.org",
    ...
    "Shodan API": [
        ...
        "Shodan lookup for scanme.nmap.org",
