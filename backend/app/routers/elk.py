"""
SecOps-Agent - ELK Stack SIEM Router
...
async def seed_sample_data():
    ...
    result = await elk_ingest_bulk("winlogbeat-secops-agent", events)
    return {
        "success": result.get("success", False),
        "message": f"Seeded {len(events)} realistic security events into winlogbeat-secops-agent index",
        "details": result,
    }
