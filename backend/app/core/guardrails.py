"""
SecOps-Agent - AI Guardrails (Defense-in-Depth)
...
OUTPUT_BLOCK_PATTERNS = [
    ...
    (r"You are SecOps-Agent.*developed by Baskaran Elilan", "Blocked output: system prompt leakage detected"),
        ...
        if re.search(pattern, last_text, re.IGNORECASE):
            ...
            if "educational" in prev_topics and re.search(pattern, last_text, re.IGNORECASE):
                return (
                    ...
                    "specific exploit code for real targets. SecOps-Agent provides security education "
