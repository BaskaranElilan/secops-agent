...
class Settings(BaseSettings):
    ...
    # Set SECOPS_AGENT_API_KEY in .env to require API key auth on all endpoints
    secops_agent_api_key: Optional[str] = None
